...
/// </summary>
Camera::Camera(void) : m_eye(0.0f, 20.0f, 20.0f), m_at(0.0f), m_up(0.0f, 1.0f, 0.0f), m_speed(16.0f), m_goFw(0), m_goRight(0), m_slow(false)
{
...
Camera::Camera(glm::vec3 _eye, glm::vec3 _at, glm::vec3 _up) : m_dist(10), m_speed(16.0f) ,m_goFw(0), m_goRight(0), m_slow(false)
{
